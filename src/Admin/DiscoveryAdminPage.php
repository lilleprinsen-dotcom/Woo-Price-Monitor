...
class DiscoveryAdminPage {
	...
	private function render_manual_discovery_panel(): void {
		...
		<div class="notice notice-info inline" data-lpm-manual-discovery-panel data-selected-product-count="<?php echo esc_attr( (string) count( $products ) ); ?>" data-active-competitor-count="<?php echo esc_attr( (string) count( $competitors ) ); ?>" style="margin:14px 0;padding:12px 14px;">
			...
			<div style="display:flex;gap:10px;align-items:flex-end;flex-wrap:wrap;margin:10px 0;">
				<label><?php esc_html_e( 'Product', 'lilleprinsen-price-monitor' ); ?><br>
				...
				<label><?php esc_html_e( 'Competitor', 'lilleprinsen-price-monitor' ); ?><br>
			...
			<table class="widefat striped" data-lpm-manual-results hidden style="margin-top:12px;">
	...
	private function render_step_guidance( int $current_step ): void {
		...
		?>
		<div class="notice notice-info inline" style="margin:10px 0 14px;padding:10px 12px;">
			<p style="margin:0;"><strong><?php printf( esc_html__( 'Current step %1$d of 7:', 'lilleprinsen-price-monitor' ), absint( $current_step ) ); ?></strong> <?php echo esc_html( $current ); ?></p>
			<p style="margin:4px 0 0;"><strong><?php esc_html_e( 'Next step:', 'lilleprinsen-price-monitor' ); ?></strong> <?php echo esc_html( $next ); ?></p>
		</div>
		<?php
	}
