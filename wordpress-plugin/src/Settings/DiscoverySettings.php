...
class DiscoverySettings {
	...
	public function defaults(): array {
		return array(
			...
			'discovery_visual_matching_enabled'   => 1,
			'discovery_visual_remote_image_embeddings_enabled' => 0,
			...
			'discovery_max_crawl_candidate_urls'  => 40,
	...
	public function sanitize( array $input ): array {
		...
		return array(
			...
			'discovery_visual_matching_enabled'   => empty( $input['discovery_visual_matching_enabled'] ) ? 0 : 1,
			'discovery_visual_remote_image_embeddings_enabled' => empty( $input['discovery_visual_remote_image_embeddings_enabled'] ) ? 0 : 1,
			'discovery_name_search_enabled'       => empty( $input['discovery_name_search_enabled'] ) ? 0 : 1,
			...
			'discovery_max_crawl_candidate_urls'  => $this->sanitize_int( $input['discovery_max_crawl_candidate_urls'] ?? $defaults['discovery_max_crawl_candidate_urls'], 1, 200 ),
