...
use Lilleprinsen\PriceMonitor\Service\ProductMatchEvidenceService;
...
final class Plugin {
	...
	public function init(): void {
		...
		$external_worker      = new ExternalBrowserWorkerClient( $url_service );
		$price_check          = new PriceCheckService( null, $repository, $external_worker );
		...
		$visual_matcher       = new VisualProductMatchService( $discovery_settings );
		$match_suggestions    = new MatchSuggestionService( $discovery_repository, new ProductMatchEvidenceService( $visual_matcher ) );
